export const INITIAL_DATA = {
  settings: {
    email: "wasey351@gmail.com",
    phone1: "+92 (341) 1236082",
    phone2: "+92 (310) 2454778",
    linkedin: "https://www.linkedin.com/in/heiswasay/",
    facebook: "",
    instagram: "",
    whatsapp: "",
  ...
  skills: [
    ...
    { id: 3, name: "Content Development" },
    { id: 4, name: "Marketing Strategist" },
    { id: 5, name: "Digital Growth" },
    { id: 6, name: "Marketing Planning & Execution" }
  ],
  experience: [
    {
      id: 1,
